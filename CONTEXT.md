...
| **LLM Refine** | An optional post-processing step that sends Thai translation text from Google Lens through a local LLM (Gemma 4 E4B via Ollama) to polish phrasing, naturalness, and manga dialogue tone. |
